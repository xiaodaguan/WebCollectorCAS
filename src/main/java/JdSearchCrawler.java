 ...
 */
public class JdSearchCrawler extends BreadthCrawler {
    ...
    final private static int MAX_THREAD = 1;//max request thread count
    final private static int REQUEST_INTERVAL = 5;//seconds

    final private static boolean RESUMABLE = false;
    final private static String RUN_MODE = "test";//test or run
    //    final private static String RUN_MODE = "run";
    final private static int DEPTH = 16;
    ...
    public JdSearchCrawler(String crawlPath, boolean autoParse) throws UnsupportedEncodingException {
        ...
        jdbcTemplate = JDBCHelper.createOracleTemplate("oracleTireTemplate", "jdbc:oracle:thin:@" + DB_URL, DB_USER, DB_PASSWORD, 5, 30);
    ...
    public void visit(Page page, CrawlDatums crawlDatums) {
        if (page.getUrl().contains("search.jd.com")) {
            // parse list
        ...
        } else if (page.getUrl().contains("item.jd.com")) {
            // parse item
    ...
    private void fillData(String price, String sale_num, String search_keyword, int category_code, String brand, String title, String product_img, String diameter, String width, String info, String url, String md5, String code_num, String model, String year_month, EbData ebData) {
        ...
        ebData.setInfo(info);
        ebData.setSearch_keyword(search_keyword);
     ...
     * @return next
     */
    private String getPagingUrl(String url) {
        String nextUrl;
    ...
    public static void main(String[] args) throws Exception {
        ...
        jdsCrawler.setThreads(MAX_THREAD);
        jdsCrawler.setResumable(RESUMABLE);
        jdsCrawler.setExecuteInterval(REQUEST_INTERVAL * 1000);
        jdsCrawler.start(DEPTH);
